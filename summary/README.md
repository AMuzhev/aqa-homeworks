...
Что мы хотим запланировать: тестирование возможности записаться на обучение профессии «Тестирование программного обеспечения (QA)»:

![image](https://github.com/user-attachments/assets/fe6db753-732b-4556-875f-b14460d49f57)

Попасть на эту форму со страницы профессии можно двумя способами: пролистать всю страницу Интенсивные программы до формы записи, а также нажатием кнопки «Записаться» на странице Интенсивные программы.
А вот способы попасть на страницу профессии с главной страницы сайта вам предстоит исследовать самостоятельно. Это можно сделать как через меню «Интенсивные программы», так и через некоторый контент на главной странице.

Где можно начать искать страницу с "Интенсивные программы" на главной странице сайта:

![image](https://github.com/user-attachments/assets/8fd00d5b-fa7f-494d-89a3-d93704e65f72)
